...
ChatGPTには **「⏹ 停止」ボタン** があります。返事が長すぎたとき、押すと **途中でピタッと止まる**。第11章（[SSE](11-streaming-sse.md)）・第12章（[WebSocket](12-websocket.md)）で「1文字ずつ流す」を作りましたが、**流している最中に止める**には、もうひと工夫いります。
