...
> 📌 **実際の攻撃は、これらを“組み合わせて”くる** — 偽の採用・面接、OSSのDMからの罠、ディープフェイク会議、MFAの回避など、最近の複合型の事例は [付録：最近の手口と「組み合わせ型」攻撃](security-modern-attacks.md) にまとめました。
...
- [付録：最近の手口と「組み合わせ型」攻撃](security-modern-attacks.md) — 偽採用・OSS DM・ディープフェイク会議・MFA回避など最新の複合事例
