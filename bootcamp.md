...
1. **従来コース** — 今まで通り、約9ヶ月で具体的なサービス・アプリケーションを立ち上げるコース。最後までやり切れる開発・設計スキルが必要です
...
- 参加コースに応じて **6〜9ヶ月**、**週に2日分（16時間）以上**の時間を確保できる方
...
- 応募は [応募フォーム](https://forms.gle/zEVZjsLnCoWdsmf89) から（チーム参加でも1人ずつ申し込み）
...
- **ブートキャンプのために、参加コースに応じて 6〜9ヶ月、週に2日分（16時間）以上の時間を確保できる方**
  - 従来コースは約9ヶ月（〜3月最終発表）、Vibe Coding コースは6ヶ月（希望者は9ヶ月まで延長可）、MulmoCast / MulmoClaude コースはプロジェクト内容に応じて 6〜9ヶ月が基本です
...
- 2026年は、以下の4つのコースを想定しています
  - **従来コース** — 具体的なアプリケーション、サービスを **約9ヶ月**（〜2〜3月の最終発表）で作っていくコース
...
応募は **コース**（従来コース／Vibe Coding コース／MulmoCast・MulmoClaude コース／広報コース）と **役割** の二軸で受け付けます。コースは取り組み方の違い、役割は持ち寄るスキルの違いです。
