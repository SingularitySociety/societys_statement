...
- **ブートキャンプのために、６ヶ月間、週に2日分（16時間）以上の時間を確保できる方**
...
- 2026年は、以下の２つのコースを想定しています
  - Vibe codingをメインにし、業務改善やプロトタイピングを早いサイクルで作っていくコース
    - オンラインミーティングの時間帯が合う人達で３〜５人のチームをつくり、それぞれサポートしながら進めていただきます
    - わからない事があれば非同期でサポートします
    - 最初の三か月は週１でMeetsでの参加者報告会を開催し、状況のアップデートをしていただきます。
  - 従来通り具体的なアプリケーション、サービスを９か月で作っていくコース
